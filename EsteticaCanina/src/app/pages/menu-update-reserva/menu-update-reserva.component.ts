...
@Component({
  selector: 'app-menu-update-reserva',
  templateUrl: './menu-update-reserva.component.html',
  styleUrls: ['./menu-update-reserva.component.scss']
})
export class MenuUpdateReservaComponent implements OnInit {
